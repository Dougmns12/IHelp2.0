<html>
	<body><h2>Atualizar Pessoa</h2>
		<form action="cadastrarcarro.php" name="formCarro" 
...
if($renavam != ""){
	$erro = cadastrarCarro($renavam, $marca, $placa, $chassi, $anoFabricacao, $anoModelo);
...
function cadastrarCarro($renavam, $marca, $placa, $chassi, $anoFabricacao, $anoModelo){

	$con = abrirConexao();

	$sql = "INSERT INTO Carros(renavam, marca, placa, chassi, anoFabricacao, anoModelo) VALUES (" .
		"'" . $renavam . "', " .
		"'" . $marca . "', " .
		"'" . $placa . "', " .
		"'" . $chassi . "', " .
